...
const PROJECT_KEYS = ['quickfy-app', 'quickfy-web', 'fl1', 'flowmatics', 'singleflo', 'biemme'] as const

// Category keys for filtering
const CATEGORY_KEYS = ['all', 'webapp', 'saas', 'b2b-automation', 'landing-page', 'business-website'] as const
...
const BENTO_CONFIG: Record<typeof PROJECT_KEYS[number], 'wide' | 'default'> = {
  'quickfy-app': 'wide',    // Row 1: wide left
  'quickfy-web': 'default', // Row 1: standard right
  'fl1': 'default',         // Row 2: standard left
  'flowmatics': 'wide',     // Row 2: wide right
  'singleflo': 'wide',      // Row 3: wide left
  'biemme': 'default',      // Row 3: standard right
}
...
const PROJECT_STATIC_DATA: Record<typeof PROJECT_KEYS[number], {
  ...
  'singleflo': {
    ...
    images: ['/portfolio/singleflo-1.webp', '/portfolio/singleflo-2.webp'],
    technologies: ['Next.js', 'Tailwind', 'Framer Motion', 'TypeScript', 'Vercel'],
  ...
  'biemme': {
    ...
    category: 'business-website',
    images: ['/portfolio/biemme-1.webp', '/portfolio/biemme-2.webp'],
    technologies: ['Next.js', 'Tailwind', 'Framer Motion', 'TypeScript', 'Vercel'],
...
export function PortfolioPage() {
  ...
  const projects: ProjectData[] = useMemo(() => {
    return PROJECT_KEYS.map(key => {
      ...
      const useNewTranslations = key === 'singleflo' || key === 'biemme'
      ...
      return {
        ...
        categoryKey: staticData.category,
      ...
      <Section className="relative min-h-screen pt-24 pb-16 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-accent-orange font-medium">{t('badge')}</span>
          </motion.div>
          ...
          <p className="relative text-lg text-text-secondary max-w-2xl mx-auto">
            {t('description')}
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative z-10 flex flex-wrap justify-center gap-2 mb-10"
        >
